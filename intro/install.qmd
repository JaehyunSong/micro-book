...
![](Figs/Install/Binder_Setup.png)

**手順6:** 以下のような画面が表示されたら初期設定は完了

![](Figs/Install/Jupyterhub_home.png)
...
**手順1:** 以下のアドレスにアクセスするか、本ページの右上にある右上の<a href="https://jupyter.cs.rcos.nii.ac.jp/" target="_blank"><i class="bi bi-graph-up"></i></a>ボタンをクリックする。
...
![](Figs/Install/Jupyterhub_serverlist.png)
...
![](Figs/Install/RStudio_launch.png)

**手順2:** 以下の画面が表示されたら、RStudioの起動完了である（RStudioの見栄は初期状態の場合、白ベースである）。

![](Figs/Install/RStudio_home.png)
